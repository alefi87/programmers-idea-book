...
const calculateChange = require('../../change-return/change.js').calculate;
...
describe('Change calculator', () => {
  ...
  it('calculates large change', () => {
    expect(calculateChange(0.34, 12)).to.be.deep.equal({
      10: 1, 1: 1, 0.5: 1, 0.1: 1, 0.05: 1, 0.01: 1,
    });
    expect(calculateChange(12.54, 336)).to.be.deep.equal({
      100: 3, 20: 1, 2: 1, 1: 1, 0.25: 1, 0.1: 2, 0.01: 1,
    });
  });
});
